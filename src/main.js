...
function analyzeSalesData(data, options) {
    ...
    if(typeof calculateRevenue !== "function") {
        throw new Error('переменная calculateRevenue не определена');
    } else if(typeof calculateBonus !== "function") {
        throw new Error('переменная calculateBonus не определена');
    }
